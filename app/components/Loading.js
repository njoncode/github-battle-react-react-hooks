 ...
 * Wenever we want to interact with the world outside of React (whether that’s to make a network request, manually update the DOM, mutating non-local variables, etc.), you’d reach for useEffect.
